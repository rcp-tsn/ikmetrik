                                ...
                                <div class="col-lg-12">
                                    <div class="card card-body border-top-1 border-top-pink">
                                        <div class="text-center">
                                            ...
                                            <h6 class="m-0 font-weight-semibold font-size-14 text-danger">E-PUANTAJ İLE ARTIK DAHA KOLAY</h6>
                                            <p class="text-muted mb-3">TÜM PUANTAJLARINIZI ZAMAN DAMGASI İLE TÜM PERSONELLERE DAĞITILACAKTIR.</p>
                                            ...
                                            <div class="form-group">
                                                <button type="button" onclick="stepManager.work('Pdk_pdf_Set');" class="btn btn-success start-incentive" id="start-incentive" style="display: none;">
...
@push('scripts')
    ...
    <script>
        var steps = {
            'Pdk_pdf_Set': {
                url: '{!! route('pdks.pdksStore') !!}',
                loginurl: '',
            },
            'pdkParse2':
                {
                    url: '{!! route('pdks.pdksStore2') !!}',
                    loginurl: '',
                }
        };
        ...
        var uploadURL = "{{route('pdks.pdksSave')}}";
