    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="payroll_accept_employee" action="{{route('employee_pdks_accept')}}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-lg-9 ">
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: 300px;">
                <form  id="protestForm" method="POST" action="{{route('pdks_protest')}}">
                    @csrf
...
<div class="modal fade slide-up disable-scroll" id="editModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel">Yeni PUANTAJ Tek Sayfa Olacak Şekilde Pdf Formatında Yüklenmelidir Kişiye Ait PUANTAJ Yüklendiğinden Emin Olun</h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <div class="modal-body">
                <form  method="post" action="{{route('pdks.edit')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group ">
