<div class="modal fade" id="leaveModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        ...
        <div class="modal-content ">
            ...
            <div class="modal-body" style="font-size: 20px;font-weight: 700;">
                <table id="headerTable" class="m-b-sm" border="1" cellpadding="0" cellspacing="0" data-selector="modalContainer">
                    <thead>
                    <tr>
                        <td> <img  style="border:none; height: 70px;width: 100px; margin-right: 5px; "  src="/{{$company->logo}}"></td>
                        <td>
                ...
                <table class="m-b-sm" border="1" cellpadding="0" cellspacing="0" data-selector="modalContainer">
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="space-left">{{ ezey_get_dateformat($employeeLeave->start_date,'toOur')}}</td>
                    </tr>

                    <tr>
                        <td class="stil">İzin Bitiş Tarihi</td>
                        <td colspan="3">{{ ezey_get_dateformat($employeeLeave->job_start_date,'toOur')}}</td>
