                                    ...
                                    <tr>
                                        <td>
                                            <div class="symbol symbol-50 symbol-light mt-1">
                                                <img src="{{ $user->pictureLink }}" class="h-75 align-self-end" alt="">
                                            </div>
                                        </td>
                                        ...
                                        <td>{{ $user->email }}</td>
                                        <td nowrap="nowrap">
                                            <a href="{{ route('users.edit', createHashId($user->id)) }}" title="Düzenle" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3 edit-button-area">
                                            ...
                                            <a href="{{ route('users.withLogin', createHashId($user->id)) }}" title="Yönetici olarak giriş yap." class="btn btn-icon btn-light btn-hover-primary btn-sm">
																<span class="svg-icon svg-icon-md svg-icon-primary">
