                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 options-div">
                                        <label class="option options-bolumu">
                                            <span class="option-control">
                                                <span class="radio">
                                                    <input type="checkbox" name="options[]" value="7319" >
                                                    <span></span>
                                                </span>
                                            </span>
                                            <span class="option-label">
                                                <span class="option-head">
                                                    <span class="option-title">31.Madde</span>
                                                    <span class="option-focus">7319</span>
                                                </span>
                                                <span class="option-body">7319 / 4447/GEÇİCİ 31.MADDE (Kredi Kullanan Firmalar)</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-lg-4"></div>
