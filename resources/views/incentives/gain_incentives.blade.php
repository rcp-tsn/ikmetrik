...
@section('content')
                                            ...
                                            <tr>
                                                ...
                                                @foreach($active_gains as $active_gain)
                                                    @php
                                                        ...
                                                        $toplam_3294 += $active_gain->law_3294;
                                                ...
                                                @php
                                                    $toplam = $toplam_6111 + $toplam_27103 + $toplam_14857 + $toplam_7252 + $toplam_3294;
                                                    if ($toplam == 0) {
                                                       $yuzde_6111 = 0;
                                                       $yuzde_27103 = 0;
                                                       $yuzde_7252 = 0;
                                                       ...
                                                       $yuzde_3294 = ($toplam_3294 * 100 ) / $toplam;
                                                    }
                                                    ...
                                                    $chart_pie_toplam_3294 = $toplam_3294;
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <circle fill="#000000" cx="12" cy="9" r="5"></circle>
                                                ...
                                                <td class="pl-0">
                                                    <a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">Kanun No: 3294</a>
                                                    <span class="text-muted font-weight-bold d-block">Teşvik Tutarı</span>
                                                </td>
                                                <td>
                                                    ...
                                                    <span class="text-muted mr-2 font-size-md font-weight-bold">
                                                        {{ intval($yuzde_3294) }}%
                                                            ...
                                                            <span class="text-muted font-size-md font-weight-bold">
                                                        {!! number_format($toplam_3294, 2, ',', '.') !!} TL
                                                    </span>
                                                        </div>
                                                        <div class="progress progress-xs w-100">
                                                            <div class="progress-bar bg-danger" role="progressbar" style="width: {{ intval($yuzde_14857) }}%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                            ...
                            <div class="card card-custom card-border">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered mb-6">
                                        ...
                                        <tr>
                                            <th scope="row">3294 Sayılı Kanun</th>
                                            <td>{!! number_format($chart_pie_toplam_3294, 2, ',', '.') !!} TL</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Kalan Pirim Tutarı</th>
                                            <td>{!! number_format($chart_pie_toplam_tutar - ($chart_pie_toplam_5510 + $chart_pie_toplam_6111 + $chart_pie_toplam_27103 + $chart_pie_toplam_14857 + $chart_pie_toplam_3294), 2, ',', '.') !!} TL</td>
                                        </tr>
                                        <tr>
