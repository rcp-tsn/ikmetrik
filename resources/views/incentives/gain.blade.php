                                ...
                                <div class="col-lg-12">
                                    <div class="card card-body border-top-1 border-top-pink">
                                        <div class="text-center">
                                            <h6 class="m-0 font-weight-semibold">E-BildirgeV2 SİSTEMİNDEN ONAYLI BİLDİRGELERİ ÇEK VE İŞVEREN İLE DEVAM ET </h6>
                                            ...
                                            <button type="button" onclick="stepManager.work('v2_tahakkuk_list');" class="btn btn-success start-incentive"><b><i class="icon-collaboration"></i></b> Devam Et</button>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="example-preview">
                                                    <table class="table table-bordered mb-6">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th scope="col">Tanımlama Durumu</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        @if(!empty($declaration_services))
                                                            @php
                                                                session(["tanimlamalara_bakilacakmi" => false]);
                                                            @endphp
                                                            @foreach($declaration_services as $declaration_service)
                                                                <tr>
                                                                    <th scope="row">{{ $declaration_service->tck }}</th>
                                                                    <td>{{ $declaration_service->isim }} {{ $declaration_service->soyisim }}</td>
                                                                    <td>{{ $declaration_service->job_start->format('d/m/Y') }}</td>
                                                                    <td>
                                                                        @if($declaration_service->calisanTanimlandimi($sgk_company->id))

                                                                        <span class="label label-inline label-light-success font-weight-bold">EVET</span>
                                                                            @else
                                                                            @php
                                                                                session(["tanimlamalara_bakilacakmi" => true]);
                                                                            @endphp
                                                                            <span class="label label-inline label-light-danger font-weight-bold">HAYIR</span>
                                                                        @endif
                                                                    </td>
                                                        ...
                                                        @else
                                                            ...
                                                            @endphp
                                                            <tr>
                                                                <th scope="row" colspan="5">İşe giriş olmadığı için tanımlama işlemi yapılmayacaktır.</th>
                                                            </tr>
                                                        @endif
...
@push('scripts')
    <script>
        var steps = {
            ...
            /*
            'v3_new_request2': {
                url: '{!! route('declarations.v3.NewRequest2') !!}',
                loginurl: '{!! route('declarations.loginv3.post') !!}',
            },
            */
            'v3_3294': {
