                    ...
                    <div class="card card-custom gutter-b ">
                        <div class="card-header h-auto border-0">
                            <div class="card-title py-5">
                                <h3 class="card-label">
                                    <span class="d-block text-dark font-weight-bolder">Metrik Verilerini Çek</span>
                                </h3>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-lg-12">
                                    <div class="card card-body border-top-1 border-top-pink">
                                        <div class="text-center">
                                            <h6 class="m-0 font-weight-semibold">V2 İle Başla</h6>
                                            <p class="text-muted mb-3">SGK Ebildirge V2 sistemi üzerinden bildirgeleri çeker.</p>
                                            <button type="button" onclick="stepManager.work('v2_metrik_tahakkuk_list');" class="btn btn-success start-incentive"><b><i class="icon-collaboration"></i></b> Devam Et</button>
                                        </div>
                                    </div>
                                </div>
...
@push('scripts')
    <script>
        var steps = {
            'v2_metrik_tahakkuk_list': {
                url: '{!! route('declarations.v2.TahakkukListMetrik') !!}',
                loginurl: '{!! route('declarations.loginv2.post') !!}',
            },
            'v2_pdf_download_metrik': {
                url: '{!! route('declarations.v2.PdfDownloadMetrik') !!}',
                loginurl: '{!! route('declarations.loginv2.post') !!}',
            },
            'v2_pdf_parse_metrik': {
                url: '{!! route('declarations.v2.PdfParseMetrik') !!}',
                loginurl: '{!! route('declarations.loginv2.post') !!}',
            }
        };

        var stepManager = {
            currentStep: 'v2_metrik_tahakkuk_list',
            work: function (step) {
