...
<div class="container" style="padding: 30px;">
	<div class="row">
    	...
    	?>
    	<form method="GET" action="/transferrateincompany" style="width: 100%;">
