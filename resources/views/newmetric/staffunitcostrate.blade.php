...
<div class="container" style="padding: 30px;">
	<div class="row">
    	...
    	?>
		<form method="GET" action="/sub-metrics/staff-unit-cost-rate" class="date-form">
			<div class="row">
		...
		<div class="col-lg-12">
			...
			<div class="card card-custom gutter-b">
				...
				<div class="card-body" style="<?php if($firma_yuzdesi==0 || $sektor_yuzdesi==0) echo 'display: none;' ?>">
					...
					<span><b>Firmanızın Ortalama Maliyeti : {{number_format($firma_toplam_maliyet,2,',','.')}} ₺</b></span><br>
					<span><b>Firmanızın Ortalama Personel Sayısı : {{number_format($firma_calisan_sayisi,0,',','.')}} Kişi</b></span>
					<!--begin::Chart-->
					...
					if ($firma_yuzdesi<=$max AND $firma_yuzdesi>=$min) {
						...
						$degerlendirme_mesaji="Değerlendirme oranınız sektör ortalama değerinin altında olup ,birim maliyet oranı durumunuz olumlu yönde seyretmektedir."; ?>
