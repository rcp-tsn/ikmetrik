...
<div class="container" style="padding: 30px;">
	<div class="row">
    	...
    	?>
		<form method="GET" action="/sub-metrics/extra-pay-cost-rate" class="date-form">
			<div class="row">
		...
		<div class="col-lg-12">
			...
			<div class="card card-custom gutter-b">
				<div class="card-header">
					<div class="card-title" style="width: 100%;">
						<h3 class="card-label"style="width: 50%;">
							Firmanızın Ek Ödeme Maliyet Oranı : %{{number_format($firma_yuzdesi,1,',','.')}}
						</h3>
						<h3 class="card-label" style="width: 50%;text-align: right;">
							Sektör Ek Ödeme Maliyet Oranı :  %{{number_format($sektor_yuzdesi,1,',','.')}}
						</h3>
					</div>
				</div>
					...
					<div class="alert alert-custom alert-outline-primary fade show mb-5" role="alert" style="background-color: #ff7f00;border-color: #ff7f00;margin-top: 20px;">
						...
						<div class="alert-text" style="color: #fff;">
							...
							@elseif($firma_yuzdesi==0)
								@if($firma_ek_odeme_maliyet==0)
								Seçilen tarih aralığında firmanızın ek ödemesi yoktur. Dolayısıyla karşılaştırma yapılamamaktadır.
								@else
				...
				<div class="card-body" style="<?php if($firma_yuzdesi==0 || $sektor_yuzdesi==0) echo 'display: none;' ?>">
					...
					<span><b>Firmanızın Toplam Ek Ödeme Maliyeti : {{number_format($firma_ek_odeme_maliyet,2,',','.')}} ₺</b></span><br>
					...
					if ($firma_yuzdesi<=$max AND $firma_yuzdesi>=$min) {
						$degerlendirme_mesaji="Değerlendirme oranınız sektör ortalamasının içerisinde olup ek ödeme maliyet oranınız sektör ortalamasına göre nominal değerdedir."; ?>
						<div class="alert alert-custom alert-outline-primary fade show mb-5" role="alert" style="background-color: #424a52;border-color: #424a52">
							...
							<div class="alert-text" style="color: #fff;">
								Değerlendirme oranınız sektör ortalamasının içerisinde olup ek ödeme maliyet oranınız sektör ortalamasına göre nominal değerdedir.
							</div>
						</div><?php
					}elseif ($firma_yuzdesi<$min) {
						$degerlendirme_mesaji="Değerlendirme oranınız sektör ortalama değerinin altında olup ,ek ödeme maliyet oranı durumunuz olumlu yönde seyretmektedir."; ?>
						<div class="alert alert-custom alert-outline-primary fade show mb-5" role="alert" style="background-color: #2a6ab2;border-color: #2a6ab2">
							...
							<div class="alert-text" style="color: #fff;">
								Değerlendirme oranınız sektör ortalama değerinin altında olup ,ek ödeme maliyet oranı durumunuz olumlu yönde seyretmektedir.
							</div>
						</div><?php
...
<script type="text/javascript">
	...
	var sektor_yuzdesi=<?php  echo $sektor_yuzdesi; ?>;
		...
		chart.data = [{
		  "baslik": "Sektör Bazlı Firmanızın Ek Ödeme Maliyet Oranı",
		  "yuzde": firma_yuzdesi,
		  "color": am4core.color("#168FC6"),
		}, {
		  "baslik": "Sektörün Firmanıza Göre Ek Ödeme Maliyet Oranı",
