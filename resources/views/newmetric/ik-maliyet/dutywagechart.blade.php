	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div style="width: 33%;min-height: 200px;float: left;padding: 5px 10px;">
				<img src="/pictures/28.png" style="width: 100%;height: auto;">
			</div>
			<div style="width: 60%;float: left;font-size: 15px;padding-top: 10px;">
				<p style="text-align: justify;">
					...
					Bildirgeler üzerinden tanımlana görevlerin ücret ile ilişkisini tanımlamaktadır.<br><br>
					<span class="formulgoster" id="formulgoster">Formülü Göster</span><br>
					<b class="formul">Hesaplama Formülü : Görev bazında ücret dağılım grafiği</b>
					<br>
				</p>
			</div>
		</div>
    	...
    	?>
		<form method="GET" action="/dutywagechart" style="width: 100%;">
			<div class="row">
...
<script type="text/javascript">
	...
	for (var i =0 ; i < arraysektor.length; i++) {
		sektor_job_yuzde=parseInt(arraysektor[i]['toplamucret']+arraysektor[i]['toplamikramiye']);
