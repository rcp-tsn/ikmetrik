	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div style="width: 33%;min-height: 200px;float: left;padding: 5px 10px;">
				<img src="/pictures/12.png" style="width: 100%;height: auto;">
			</div>
			<div style="width: 60%;float: left;font-size: 15px;padding-top: 10px;">
				<p style="text-align: justify;">
					Sosyal Güvenlik Kurumu (SGK) teşvik, istihdamın artması ve işsizliğin azalmasını sağlamak amacıyla, yine Sosyal Güvenlik Kurumu'nun belirlediği şartlara göre birçok iş yerinin ve işçinin desteklenmesi olarak açıklanmaktadır.Rekabetçi yaklaşımın tüm unsurları ile çalışma hayatının dinamiklerini etkilemek ile birlikte işverenler üzerinde ki maliyet – verimlilik ilişkisi önem arzetmektedir.İşverenlere destek amacı ile yürürlükte bulunan 15 ayrı teşvik işlemlerinin kişi bazında faydalanma oranını SGK nezlinde tanımlar.<br><br>
					<span class="formulgoster" id="formulgoster">Formülü Göster</span><br>
					<b class="formul">Hesaplama Formülü:Toplam teşvik kazancı/Ortalama Çalışan Sayısı</b><br>
				</p>
			</div>
		</div>
		<?php 
    	...
    	?>
    	<form method="GET" action="/personbasedincentiverate" style="width: 100%;">
