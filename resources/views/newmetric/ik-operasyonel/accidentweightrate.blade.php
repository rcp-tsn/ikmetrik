...
<div class="container" style="padding: 30px;">
	<div class="row">
    	...
    	?>
		<form method="GET" action="/accidentweightrate" style="width: 100%;">
			<div class="row">
		...
		<?php  $firma_yuzdesi= $firma_kayip_gun_sayisi/$firma_calisilan_gun_toplami*1000; ?>
		<?php  $sektor_yuzdesi= $sektor_kayip_gun_sayisi/$sektor_calisilan_gun_toplami*1000; ?>
		<div class="col-lg-12">
			<!--begin::Card-->
