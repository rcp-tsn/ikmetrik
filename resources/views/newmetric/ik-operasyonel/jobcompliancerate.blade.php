...
<div class="container" style="padding: 30px;">
	<div class="row">
    	...
    	?>
		<form method="GET" action="/jobcompliancerate" style="width: 100%;">
			<div class="row">
