	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div style="width: 33%;min-height: 200px;float: left;padding: 5px 10px;">
				<img src="/pictures/8.png" style="width: 100%;height: auto;">
			</div>
			<div style="width: 60%;float: left;font-size: 15px;padding-top: 10px;">
				<p style="text-align: justify;">
					İşten ayrılma neden grafiği ,işletmede çalışanların isten ayrılma nedenlerini(istifa,bildirili fesih,emeklilik,askerlik,iyi niyet ve ahlak dışı fesih,nedeme süreci vb. ) şirket çin iş gücünü tanımlar.Bu metrik işletme bazında çıkış süreçlerin incelenerek olası kurum hazfızasının ve kültürünün korunması noktasında önem arzeder.İşten ayrılan personelerin ayrılış nedenlerine göre tanımlammasını ifade eder.<br><br>
					<span class="formulgoster" id="formulgoster">Formülü Göster</span><br>
					<b class="formul">Hesaplama Formülü : Neden sonuç pasta grafiği</b><br>
				</p>
			</div>
		</div>
		<?php 
    	...
    	?>
		<form method="GET" action="/reasonofquitjob" style="width: 100%;">
			<div class="row">
