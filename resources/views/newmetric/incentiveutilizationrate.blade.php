	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="metric-image-div">
				<img src="/pictures/11.jpg" style="width: 100%;height: auto;">
			</div>
			<div class="metric-define-div">
				<p style="text-align: justify;">
					...
					<span class="formul"><b>Hesaplama Formülü :</b> Toplam teşvik kazancı/Toplam personel maliyeti</span><br>
				</p>
			</div>
		</div>
		<?php
    	...
    	?>
		<form method="GET" action="/sub-metrics/incentive-utilization-rate" class="date-form">
			<div class="row">
