                ...
                <div class="card-body">
                    <div class="col-lg-6">
                        <div class="d-flex align-items-center flex-wrap py-25 px-5">
                            <h2 class="text-dark font-weight-bolder mr-12">SIK SORULAN SORULAR</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="card mb-8">
                        <div class="card-body">
                            <div class="p-6">
                                <h2 class="text-dark mb-8">İK Metrik?</h2>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingOne1">
                                            <div class="card-title" data-toggle="collapse" data-target="#collapseOne1" aria-expanded="true" aria-controls="collapseOne1" role="button">
                                                ...
                                                <div class="card-label text-dark pl-4">İK Metrik Yazılım Bilişim A.Ş Kimdir?</div>
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                        <div id="collapseOne1" class="collapse show" aria-labelledby="headingOne1" data-parent="#accordionExample1">
                                            <div class="card-body text-dark-50 font-size-lg pl-12">Ana çatı şirketimiz More Payroll Bordrolama ve Teşvik Hizmetleri şirketimiz hala hazırda  14 yıllık kurumsal deneyimi  ve 70 kişilik kadrosu ile İstanbul-Bursa ve Antalya şubelerinde hizmet vermekte olup, grup şirketimiz bünyesinde Özgül Belgelendirme Ltd.Şti, Özel Modüler Rehberlik Meslek Eğitim Merkezi  bulunmaktadır.</div>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <div class="card border-top-0">
                                        ...
                                        <div class="card-header" id="headingTwo1">
                                            <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseTwo1" aria-expanded="false" aria-controls="collapseTwo1" role="button">
                                                                    <span class="svg-icon svg-icon-primary">
                                                                        <!--begin::Svg Icon | path:/metronic/theme/html/demo10/dist/assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                                <polygon points="0 0 24 0 24 24 0 24"></polygon>
                                                                                <path d="M12.2928955,6.70710318 C11.9023712,6.31657888 11.9023712,5.68341391 12.2928955,5.29288961 C12.6834198,4.90236532 13.3165848,4.90236532 13.7071091,5.29288961 L19.7071091,11.2928896 C20.085688,11.6714686 20.0989336,12.281055 19.7371564,12.675721 L14.2371564,18.675721 C13.863964,19.08284 13.2313966,19.1103429 12.8242777,18.7371505 C12.4171587,18.3639581 12.3896557,17.7313908 12.7628481,17.3242718 L17.6158645,12.0300721 L12.2928955,6.70710318 Z" fill="#000000" fill-rule="nonzero"></path>
                                                ...
                                                <div class="card-label text-dark pl-4">İK Metrik Nedir?</div>
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                        <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo1" data-parent="#accordionExample1">
                                            <div class="card-body text-dark-50 font-size-lg pl-12">İnsan Kaynakları departmanı işletme içerisinde faaliyette olan diğer departmanlara nazaran değer insan yaklaşımı ile somut veriler kullanarak süreç yönetiminin yapılmasıdır. Stratejik İK yönetimi ölçümleme/analiz yöntemi ile işletmenin rekabet edebilirliğine değer katacaktır.<br/>
                                                Tam bu noktada İK Metrik yazılımı 32 ayrı metrik hesaplaması ile tek tuşla veri girmeden dijital portalar (APHB,İşe giriş, İşten Çıkış vb.) üzerinden botlar yardımı ile ik metriklerinizi sektör değerleri ile karşılaştırarak size raporlamaktadır.</div>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header" id="headingThree1">
                                            <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseThree1" aria-expanded="false" aria-controls="collapseThree1" role="button">
                                                ...
                                                <div class="card-label text-dark pl-4">Hangi İK Metrikleri Hesaplanmaktadır?</div>
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                        <div id="collapseThree1" class="collapse" aria-labelledby="headingThree1" data-parent="#accordionExample1">
                                            <div class="card-body text-dark-50 font-size-lg pl-12">Buraya tablo gelecek.</div>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                    <div class="card">
                                        ...
                                        <div class="card-header" id="headingThree1">
                                            <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseThree1" aria-expanded="false" aria-controls="collapseThree1" role="button">
                                                ...
                                                <div class="card-label text-dark pl-4">İK Metrik Sektör Değer Karşılaştırmasını Nasıl Yapmaktadır?</div>
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                        <div id="collapseThree1" class="collapse" aria-labelledby="headingThree1" data-parent="#accordionExample1">
                                            <div class="card-body text-dark-50 font-size-lg pl-12">İK Metrik yazılımızı sektörel bazda hala hazırda 500’ü aşkın firmamız tarafından kullanılmakta olup değerler oran bazında grafikler eşlinde sunulmaktadır.</div>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                    <!--end::Item-->
                ...
                <div class="col-lg-6">
                    <div class="card mb-8">
                        <div class="card-body">
                            <div class="p-6">
                                <h2 class="text-dark mb-8">Teknik Destek</h2>
                                <!--begin::Accordion-->
                                <div class="accordion accordion-light accordion-light-borderless accordion-svg-toggle" id="accordionExample3">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header" id="headingOne3">
                                            <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseOne3" aria-expanded="false" aria-controls="collapseOne3" role="button">
                                                                    <span class="svg-icon svg-icon-primary">
                                                                        <!--begin::Svg Icon | path:/metronic/theme/html/demo10/dist/assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                ...
                                                <div class="card-label text-dark pl-4">Teknik Destek Veriliyor Mu?</div>
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                        <div id="collapseOne3" class="collapse show" aria-labelledby="headingOne3" data-parent="#accordionExample3" style="">
                                            <div class="card-body text-dark-50 font-size-lg pl-12">Teknik destek hizmetleri, fatura kesim tarihinden itibaren 1 yıl süresince telefon ve online iletişim aracılığı ile ücretsiz verilebilmektedir. Yazılımlar hakkındaki bütün sorunlarınıza dilerseniz …………………………………. numarasını arayarak, dilerseniz destek@ikmetrik.com  adresine e-mail yazarak gün içinde yanıt alabilirsiniz.</div>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header" id="headingTwo3">
                                            <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseTwo3" aria-expanded="false" aria-controls="collapseTwo3" role="button">
                                                ...
                                                <div class="card-label text-dark pl-4">İK Metrik İçin Özel Bir Bilgisayara veya Programa İhtiyaç Var mı?</div>
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                        <div id="collapseTwo3" class="collapse" aria-labelledby="headingTwo3" data-parent="#accordionExample3">
                                            <div class="card-body text-dark-50 font-size-lg pl-12">İnternet üzerinden herhangi bir ilave programa gerek olmaksızın tüm browserlardan kullanılmaktadır.</div>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header" id="headingThree3">
                                            <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseThree3" aria-expanded="false" aria-controls="collapseThree3" role="button">
                                                ...
                                                <div class="card-label text-dark pl-4">İK Metrik için özel Geliştirme Talepleri Yapılabilir mi?</div>
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                        <div id="collapseThree3" class="collapse" aria-labelledby="headingThree3" data-parent="#accordionExample3">
                                            <div class="card-body text-dark-50 font-size-lg pl-12">İşletmenin talepleri doğrultusunda ana çatı organizasyonu bozmadan yapılabilir.</div>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                    <div class="card">
                                        ...
                                        <div class="card-header" id="headingThree3">
                                            <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseThree3" aria-expanded="false" aria-controls="collapseThree3" role="button">
                                                ...
                                                <div class="card-label text-dark pl-4">İK Metrik Güncelleme Çalışmaları Nasıl Yapılmaktadır?</div>
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                        <div id="collapseThree3" class="collapse" aria-labelledby="headingThree3" data-parent="#accordionExample3">
                                            <div class="card-body text-dark-50 font-size-lg pl-12">İK Metrik güncelleme çalışmaları kurumumuz tarafından yapılmakta olup, sisteme entegre edilmektedir.</div>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                    <!--end::Item-->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card mb-8">
                        <div class="card-body">
                            <div class="p-6">
                                <h2 class="text-dark mb-8">KVKK Uyumluluğu</h2>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingOne2">
                                            <div class="card-title" data-toggle="collapse" data-target="#collapseOne2" aria-expanded="true" aria-controls="collapseOne2" role="button">
                                                ...
                                                <div class="card-label text-dark pl-4">KVKK İşlemleri Noktasında Veri Güvenliği Sağlandı Mı?</div>
                                            </div>
                                        </div>
                                        <div id="collapseOne2" class="collapse show" aria-labelledby="headingOne2" data-parent="#accordionExample2">
                                            <div class="card-body text-dark-50 font-size-lg pl-12">İK Metrik Yazılım Bilişim A.Ş 6698 Sayılı Kişisel Verileri Koruma Kanunu Kapsamında Teknik alt yapısı ve süreç yönetim sistemi kişisel verilerin koruma kanunu kapsamına uyum halindedir.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="card mb-8">
                        <div class="card-body">
                            <div class="p-6">
                                <h2 class="text-dark mb-8">Eğitim</h2>
                                <div class="accordion accordion-light accordion-light-borderless accordion-svg-toggle" id="accordionExample4">
                                    <div class="card">
                                        <div class="card-header" id="headingOne4">
                                            <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseOne4" aria-expanded="false" aria-controls="collapseOne4" role="button">
                                                                    <span class="svg-icon svg-icon-primary">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                                <polygon points="0 0 24 0 24 24 0 24"></polygon>
                                                ...
                                                <div class="card-label text-dark pl-4">İK Metrik Uygulama Eğitimi Veriliyor Mu?</div>
                                            </div>
                                        </div>
                                        <div id="collapseOne4" class="collapse show" aria-labelledby="headingOne4" data-parent="#accordionExample4" style="">
                                            <div class="card-body text-dark-50 font-size-lg pl-12">İK Metrik uygulama eğitimlerimiz sistem üzerinden portallarımızda hazırlanmış olup, ihtiyaç duyulması halinde danışmanlarımız internet üzerinden uygulamalı olarak eğitim vermektedir.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card mb-8">
                        <div class="card-body">
                            <div class="p-6">
                                <h2 class="text-dark mb-8">Tanımlamalar</h2>
                                <div class="accordion accordion-light accordion-light-borderless accordion-svg-toggle" id="tanimlamalar">
                                    <div class="card">
                                        <div class="card-header" id="headingOne2">
                                            <div class="card-title" data-toggle="collapse" data-target="#tanimlamalar1" aria-expanded="true" aria-controls="tanimlamalar1" role="button">
                                                <span class="svg-icon svg-icon-primary">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                            <polygon points="0 0 24 0 24 24 0 24"></polygon>
                                                ...
                                                <div class="card-label text-dark pl-4">Kullanıcı Nasıl Oluşturabilirim?</div>
                                            </div>
                                        </div>
                                        <div id="tanimlamalar1" class="collapse show" aria-labelledby="tanimlamalar1heading1" data-parent="#tanimlamalar">
