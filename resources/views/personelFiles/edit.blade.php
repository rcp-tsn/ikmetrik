                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b ">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">
                            {{isset($employee) ? $employee->full_name.' Üzerinden İşlem Yapılacak' : null }}
                            </h3>
                        ...
                        <!--begin::Card body-->
                        {!! Form::open(['route' => ['personelFiles.update', $id], 'method' => 'put', 'files'=>'true', 'class' => 'form', 'id' => 'ezy_standard_form']) !!}
                        <div class="card-body">
