            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b ">
                        ...
                        <!--begin::Card body-->
                        {!! Form::open(['route' => ['employee_supodinate_update', createHashId($id)], 'method' => 'put', 'files'=>'true', 'class' => 'form', 'id' => 'ezy_standard_form']) !!}
                        <div class="card-body">
                            @include('partials.alerts.error')
                            @include('performances.employees.subordinates.form')
                        </div>
