                    ...
                    <div class="card card-custom gutter-b ">
                        ...
                        <div class="card-header h-auto border-0">
                            <div class="card-title py-5">
                                <h3 class="card-label">
                                    <span class="d-block text-dark font-weight-bolder">Departman Yöneticileri</span>
                            ...
                            <table class="table table-bordered" id="kt_datatable">
                                ...
                                @foreach($departments as $department)
                                    <tr>
                                        ...
                                        <td nowrap="nowrap">
                                            <a href="{{ route('department-managers.edit', createHashId($department->id)) }}" title="Düzenle" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3 edit-button-area">
                                            ...
                                            <a href="{{ route('department-managers.destroy', createHashId($department->id)) }}" title="Sil" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3 edit-button-area">
