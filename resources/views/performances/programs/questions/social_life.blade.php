                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                @foreach($employees as $key => $employee)
                                    <div id="item_employee" class="col-xl-3 col-lg-6 col-md-6 col-sm-6 item_employee">
                                        <ul id="item">
                                            <li>d</li>
                                        </ul>
                                        <!--begin::Card-->
                                            ...
                                            <div class="card-body pt-4">
                                                ...
                                                <div class="mb-7">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <span class="text-dark-75 font-weight-bolder mr-2">Engelli Birey Varmı:</span>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-cente my-1">
                                                        <span class="text-dark-75 font-weight-bolder mr-2">Ev Kiramı:</span>
                                                        <a href="#" class="text-muted text-hover-primary" id="scholl_show">{{$employee->scholl}}</a>
                                                    </div>
                                                    <div class="d-flex justify-content-between align-items-cente my-1">
                                                        <span class="text-dark-75 font-weight-bolder mr-2">Ünv.okuyan çoçuğu var mi:</span>
                                                        <a href="#" class="text-muted text-hover-primary" id="scholl_show">{{$employee->scholl}}</a>
                                                    </div>
