...
@section('content')
    ...
    <div class="container" style="padding: 15px;">
        <div class="row" style="margin-bottom: 50px;">
            <div class="col-lg-4"></div>
            <div class="col-lg-4" style="text-align: center"><label style="font-weight: bold;font-size: 30px; color: #FFFFFF">PERFORMANS KRİTERLERİ</label></div>
            <div class="col-lg-4"></div>
        </div>
        <div class="row" >

            @foreach($performances as $performance)
                @if($performance->id != 11)
                <div class="col-xl-4">
                    <!--begin::Stats Widget 4-->
                    <div class="card card-custom card-stretch gutter-b"  >
                        <a href="{{ route('question_evalation', [ 'type' => $performance->slug_en , 'id' => createHashId($id),'page'=>1 ]) }}" disabled="disabled" class="card card-custom metric-button-hover card-shadowless gutter-b" style="height: 125px;margin-bottom: 0px;" >
                        <!--begin::Body-->
                        <div class="card-body d-flex align-items-center py-0 mt-8">
                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-5">
                                ...
                                <span class="font-weight-bold text-muted font-size-lg">{{ $performance->slug }}</span>
                            </div>
