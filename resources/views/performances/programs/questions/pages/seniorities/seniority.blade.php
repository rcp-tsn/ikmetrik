                    ...
                    <div class="card card-custom gutter-b ">
                        ...
                        <div class="card-header h-auto border-0">
                            <div class="card-title py-5">
                                <h3 class="card-label">
                                    <span class="d-block text-dark font-weight-bolder">Çalışan Kıdem Bilgileri</span>
                            ...
                            <table class="table table-bordered" id="kt_datatable">
                                ...
                                @foreach($employees as $key => $employee)
                                    <tr>
                                        ...
                                        <td>{{$employee->job_start_date->format('d/m/Y')}}</td>
                                        <td>{{$seniority_data[$employee->id]['kidem_suresi']}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
