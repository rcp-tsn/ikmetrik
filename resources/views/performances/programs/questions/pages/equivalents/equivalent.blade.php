                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b ">
                        ...
                        <div class="card-header" style="font-weight: bold;font-size: 15px;">
                            <h3 class="card-title">
                                Eş Değer Personel DEĞERLENDİRME
                            </h3>
                        ...
                        <!--begin::Card body-->
                        {!! Form::open(['route' => [ 'question_evalation_store','id' => createHashId($id),'top_manager' =>' ','type' => 'equivalents'], 'files'=>'true', 'class' => 'form', 'id' => 'kt_form']) !!}
                        <div class="mt-15">
                                                    ...
                                                    <div class="container-fluid">
                                                        <div class="card card-custom card-transparent flex-wrap bannerr" id="bannerr" style="position: fixed;width: 22%;">
                                                            <div class="card-header">
                                                                <h3 class="card-title" style="font-weight: bold;font-size: 15px;">Eş Değer Personel Seçiniz</h3>
                                                            </div>
                                                            ...
                                                            <div class="form-group" style="margin: 5px">
                                                                <label class="ml-5 mt-5" style="font-weight: bold;font-size: 15px">Eş Değer PERSONEL</label>
                                                                <div class="mt-5">
                                                                    ...
                                                                    <div class="form-group " id="next{{$key}}">
                                                                        ...
                                                                        <div class="form-group" style="margin-left: 15px">
                                                                            <div class="radio-list mt-5">
                                                                                <label class="radio">
                                                                                    <input id="" data-id="{{$key}}" type="radio" value="{{isset($puanlar[1]) ? $puanlar[1] : 1  }}" class="question"  name="radios[{{$question->id}}]">
                                                                                    <span></span>Yetersiz</label>
                                                                                <label class="radio ">
                                                                                    <input  type="radio" data-id="{{$key}}" value="{{isset($puanlar[2]) ? $puanlar[2] : 2  }}" class="question"   name="radios[{{$question->id}}]">
                                                                                    <span></span>Orta</label>
                                                                                <label class="radio">
                                                                                    <input type="radio" data-id="{{$key}}" value="{{isset($puanlar[3]) ? $puanlar[3] : 3  }}" class="question"   name="radios[{{$question->id}}]">
                                                                                    <span></span>İyi</label>
                                                                                <label class="radio">
                                                                                    <input type="radio" data-id="{{$key}}" value="{{$top_puan}}" class="question"  name="radios[{{$question->id}}]">
