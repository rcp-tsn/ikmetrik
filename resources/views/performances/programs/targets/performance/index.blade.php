    ...
    <div class="subheader py-2 py-lg-4  subheader-transparent" id="kt_subheader">
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('target.create','performances') }}" class="btn btn-primary font-weight-bold btn-sm create-button-area">
                    ...
                    <div class="card card-custom gutter-b ">
                        ...
                        <div class="card-header h-auto border-0">
                            <div class="card-title py-5">
                                <h3 class="card-label">
                                    <span class="d-block text-dark font-weight-bolder">Performans Hedefleri Yönetimi</span>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered" id="kt_datatable">
                                ...
                                @foreach($targets as $target)
                                    <tr>
                                        <td>{!! $target->performance->name !!}</td>
                                        <td>{!! $target->count() !!}</td>
                                        <td nowrap="nowrap">
                                            <a href="{{ route('target.edit', ['id'=>createHashId($target->id),'type'=>'performances']) }}" title="Düzenle" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3 edit-button-area">
