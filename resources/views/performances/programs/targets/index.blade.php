                ...
                <div class="col-lg-12">
                    ...
                    <div class=" mt-5">
                        <div class="tab-pane fade active show" id="tab-metrik" role="tabpanel" aria-labelledby="home-tab-metrik">
                            @if(Auth::user()->hasRole('Admin') || Auth::user()->hasRole('Performance') || Auth::user()->modulePermit(2))
                                <div class="row">
                                    <div class="col-xl-12">
                                ...
                                <div class="example-preview">
                                    <div class="row">
                                        <div class="col-4">
                                            <ul class="nav flex-column nav-pills" style="margin-top: 115px">
                                                <li class="nav-item mb-2 ">
                                                    <a class="nav-link active "  style="font-size: 18px;font-weight: bold" id="home-tab-5" data-toggle="tab" href="#home-5">
																			<span class="nav-icon">
																				<i class="flaticon2-chat-1"></i>
																			</span>
                                                        <span class="nav-text"  style="font-size: 18px;font-weight: bold">BİREYSEL PERFORMANS HEDEFLER YÖNETİMİ</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item mb-2">
                                                    <a class="nav-link" style="font-size: 18px;font-weight: bold" id="profile-tab-5" data-toggle="tab" href="#profile-5" aria-controls="profile">
																			<span class="nav-icon">
																				<i class="flaticon2-layers-1"></i>
																			</span>
                                                        <span class="nav-text"  style="font-size: 18px;font-weight: bold">DEPARTMAN HEDEFLERİ</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-8">
                                            <div class="tab-content" id="myTabContent5">
                                                <div class="tab-pane fade ik-metrik-area active show " id="home-5" role="tabpanel" aria-labelledby="home-tab-5">

                                                    <div class="card card-custom card-stretch gutter-b" style="">
                                                        <div class="card-body d-flex p-0">
                                                            <div class="flex-grow-1 bg-info p-12 pb-40 card-rounded flex-grow-1 bgi-no-repeat" style="background-position: calc(100% + -0.5rem) bottom; background-size: 30% auto;background-image: url(/assets/media/svg/kpi/bireysel.png);border-radius: 124px;background-color: #a19f9f!important;">
                                                                <h3 class="text-inverse-info pb-2 py-2 font-weight-bolder" style="margin-left: 32px;margin-right: 123px;font-size: 20px;">BİREYSEL PERFORMANS HEDEFLER YÖNETİMİ</h3>
                                                                <p class="text-black pt-10 pb-5 font-size-h3  line-height-lg" style="color: black;font-weight: bold">İnsan kaynakları süreçlerinde
                                                                    <br>hedef belirleme
                                                                    <br>ve analiz metrikleri</p>
                                                                <a href="{{ route('target.index','performances') }}" class="btn btn-warning  py-2 px-6"style="color: black;font-weight: bold;font-size: 17px;">HEDEFLERİ GÖSTER </a>
                                                            </div>
                                                        </div>

                                                    </div>
                                                </div>
                                                <div class="tab-pane fade ik-metrik-area" id="profile-5" role="tabpanel" aria-labelledby="profile-tab-5">

                                                    <div class="card card-custom card-stretch gutter-b">
                                                        <div class="card-body d-flex p-0">
                                                            <div class="flex-grow-1 bg-danger p-12 pb-40 card-rounded flex-grow-1 bgi-no-repeat" style="background-position: calc(100% + 0.5rem) bottom; background-size: 30% auto; background-image: url(/assets/media/svg/kpi/rapor.png);border-radius: 124px;background-color: #a19f9f!important;">
                                                                <h3 class="text-inverse-info pb-2 py-2 font-weight-bolder" style="margin-left: 32px;margin-right: 123px;font-size: 20px;">DEPARTMAN HEDEFLERİ</h3>
                                                                <p class="text-black pt-10 pb-5 font-size-h3  line-height-lg" style="color: black;font-weight: bold">Performans değerlendirme sistemi raporlama
                                                                    <br>ve döküman
                                                                    <br>yönetimi</p>
                                                                <a href="{{ route('target.index','department') }}" class="btn btn-warning  py-2 px-6"style="color: black;font-weight: bold;font-size: 17px;margin-top: 20px;">HEDEFLERİ GÖSTER</a>
                                                            </div>
                                                        </div>
                                                    </div>
...
{{--                                        <div class="card card-custom card-stretch gutter-b" style="">--}}
{{--                                            <div class="card-body d-flex p-0">--}}
{{--                                                <div class="flex-grow-1 bg-info p-12 pb-40 card-rounded flex-grow-1 bgi-no-repeat" style="background-position: calc(100% + -0.5rem) bottom; background-size: 42% auto;background-image: url(/assets/media/svg/kpi/bireysel.png);border-radius: 124px;background-color: #a19f9f!important;">--}}
{{--                                                    <h3 class="text-inverse-info pb-2 py-2 font-weight-bolder" style="margin-left: 32px;margin-right: 123px;font-size: 20px;">BİREYSEL PERFORMANS HEDEFLER YÖNETİMİ</h3>--}}
{{--                                                    <p class="text-black pt-10 pb-5 font-size-h3  line-height-lg" style="color: black;font-weight: bold">İnsan kaynakları süreçlerinde--}}
{{--                                                        <br>hedef belirleme--}}
{{--                                                        <br>ve analiz metrikleri</p>--}}
...
{{--                                        <div class="card card-custom card-stretch gutter-b">--}}
{{--                                            <div class="card-body d-flex p-0">--}}
{{--                                                <div class="flex-grow-1 bg-warning p-12 pb-40 card-rounded flex-grow-1 bgi-no-repeat" style="background-position: calc(100% + -0.5rem) bottom; background-size: 42% auto; background-image: url(/assets/media/svg/kpi/isletme.png);border-radius: 124px;background-color: #a19f9f!important;">--}}
{{--                                                    <h3 class="text-inverse-warning pb-2 py-2" style="margin-left: 32px;margin-right: 123px;font-size: 20px;font-weight: bold">İŞLETME PERFORMANS HEDEFLERİ</h3>--}}
{{--                                                    <p class="text-black pt-10 pb-5 font-size-h3  line-height-lg" style="color: black;font-weight: bold">İşletme performans değerlendirme süreçlerinde--}}
{{--                                                        <br>temel girdi--}}
{{--                                                        <br>metrikleri</p>--}}
{{--                                                    @if(Auth::user()->hasRole('Admin') || Auth::user()->hasRole('Performance') || Auth::user()->hasRole('metric'))--}}

{{--                                                        <a href="{{ route('metric_index')}}" class="btn btn-warning  py-2 px-6"style="color: black;font-weight: bold;font-size: 17px;">METRİKLERİ GÖRÜNTÜLE</a>--}}
{{--                                                    @endif--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
...
{{--                                        <div class="card card-custom card-stretch gutter-b">--}}
{{--                                            <div class="card-body d-flex p-0">--}}
{{--                                                <div class="flex-grow-1 bg-danger p-12 pb-40 card-rounded flex-grow-1 bgi-no-repeat" style="background-position: calc(100% + 0.5rem) bottom; background-size: 52% auto; background-image: url(/assets/media/svg/kpi/rapor.png);border-radius: 124px;background-color: #a19f9f!important;">--}}
{{--                                                    <h3 class="text-inverse-info pb-2 py-2 font-weight-bolder" style="margin-left: 32px;margin-right: 123px;font-size: 20px;">DEPARTMAN HEDEFLERİ</h3>--}}
{{--                                                    <p class="text-black pt-10 pb-5 font-size-h3  line-height-lg" style="color: black;font-weight: bold">Performans değerlendirme sistemi raporlama--}}
{{--                                                        <br>ve döküman--}}
{{--                                                        <br>yönetimi</p>--}}
