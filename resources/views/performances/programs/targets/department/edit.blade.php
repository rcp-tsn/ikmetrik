            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b ">
                        ...
                        <!--begin::Card body-->
                        {!! Form::open(['route' => ['target.update', createHashId($target['id']),'department'], 'method' => 'put', 'files'=>'true', 'class' => 'form', 'id' => 'kt_form']) !!}
                        <div class="">
                            @include('partials.alerts.error')
                            @include('performances.programs.targets.department.form')
                        </div>
