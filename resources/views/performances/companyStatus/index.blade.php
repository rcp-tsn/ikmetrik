                    ...
                    <div class="card card-custom gutter-b ">
                        ...
                        <div class="card-header h-auto border-0">
                            <div class="card-title py-5">
                                <h3 class="card-label">
                                    <span class="d-block text-dark font-weight-bolder">Firma Ünvan Değerleri</span>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered" id="kt_datatable">
                                ...
                                <tr>
                                    ...
                                    <th style="background-color: darkorange;font-weight: bold;font-size: 15px">ÜNVAN</th>
                                ...
                                @foreach($status as $statu)
                                    <tr>
                                        ...
                                        <td nowrap="nowrap">
                                            <a href="{{ route('status.edit', createHashId($statu->id)) }}" title="Düzenle" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3 edit-button-area">
