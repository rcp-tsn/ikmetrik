                                ...
                                <div class="col-lg-12">
                                    <div class="card card-body border-top-1 border-top-pink">
                                        <div class="text-center">
                                            <h6 class="m-0 font-weight-semibold">V2 İle İlerle</h6>
                                            <p class="text-muted mb-3">SGK Ebildirge V2 sistemi üzerinden bildirgeleri çeker.</p>
                                            <button type="button" onclick="stepManager.work('v2_bildirge');" class="btn btn-success start-incentive"><b><i class="icon-collaboration"></i></b> Devam Et</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
