                    ...
                    <div class="card card-custom gutter-b ">
                        <div class="card-header h-auto border-0">
                            <div class="card-title py-5">
                                <h3 class="card-label">
                                    <span class="d-block text-dark font-weight-bolder">{{ $request->tck }} için potansiyel teşvikler</span>
                                </h3>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-lg-12">
                                    <div class="card card-body border-top-1 border-top-pink">
                                        <div class="text-center">
                                            <h6 class="m-0 font-weight-semibold">İŞVEREN SİSTEMİ İLE DEVAM ET</h6>
                                            <p class="text-muted mb-3">Seçilen Kimlik numarası için potansiyel teşvikler taranacak</p>
                                            <button type="button" onclick="stepManager.work('v3_potential');" class="btn btn-success start-incentive"><b><i class="icon-collaboration"></i></b> Devam Et</button>
                                        </div>
                                    </div>
                                </div>
...
@push('scripts')
    <script>
        var steps = {
            'v3_potential': {
                url: '{!! route('declarations.v3.Potential') !!}',
                loginurl: '{!! route('declarations.loginv3.post') !!}',
            }
        };

        var stepManager = {
            currentStep: 'v3_potential',
            work: function (step) {
