...
<div class="container" style="padding: 30px;">
	<div class="row">
		<div class="col-lg-12">
			<h2>İş Kazası Oranı Nedir?</h2>
			<div class="metric-image-div">
				<img src="/pictures/3.jpg" style="width: 100%;height: auto;">
			</div>
			<div class="metric-define-div">
				<p style="text-align: justify;">
					08.05.2008 tarihinde yürürlüğe giren 5510 sayılı 'Sosyal Sigortalar ve Genel Sağlık Sigortası Kanunu' 13.maddesi gereğince; İşyerinde veya işin yürütümü nedeniyle meydana gelen, ölüme sebebiyet veren veya vücut bütünlüğünü ruhen ya da bedenen engelli hâle getiren kazalar olarak tanımlanmıştır.<br><br>
					<span class="formulgoster" id="formulgoster">Formülü Göster <i class="fas fa-caret-down"></i></span><br>
					<span class="formul"><b>Hesaplama Formülü :</b> Kaza sayısı/Ortalama çalışan sayısı(ayın başı+ayın sonu/2)</span><br>
				</p>
			</div>
		</div>
		<?php
    	...
    	?>
		<form method="GET" action="/sub-metrics/work-accident-rate" class="date-form">
			<div class="row">
		...
		<div class="col-lg-12">
			...
			<div class="card card-custom gutter-b">
				<div class="card-header">
					<div class="card-title" style="width: 100%;">
						<h3 class="card-label"style="width: 50%;">
							Firmanızın İş Kazası Oranı : %{{$firma_yuzdesi}}
						</h3>
						<h3 class="card-label" style="width: 50%;text-align: right;">
							Sektör İş Kazası Oranı :  %{{$sektor_yuzdesi}}
						</h3>
					</div>
				</div>
					...
					<div class="alert alert-custom alert-outline-primary fade show mb-5" role="alert" style="background-color: #ff7f00;border-color: #ff7f00;margin-top: 20px;">
						...
						<div class="alert-text" style="color: #fff;">
							...
							@elseif($firma_yuzdesi==0)
								@if($firma_kaza_sayisi==0)
								Seçilen tarih aralığında firmanıza ait herhangi bir iş kazası bulunmamaktadır.
								@else
				...
				<div class="card-body" style="<?php if($firma_yuzdesi==0 || $sektor_yuzdesi==0) echo 'display: none;' ?>">
					...
					<span><b>Firmanızın Kaza Sayısı : {{$firma_kaza_sayisi}} Kaza</b></span><br>
					...
					if ($firma_yuzdesi<=$max AND $firma_yuzdesi>=$min) {
						$degerlendirme_mesaji="Değerlendirme oranınız sektör ortalamasının içerisinde olup İş kazası oranının 0 olması hedeflenmelidir."; ?>
						<div class="alert alert-custom alert-outline-primary fade show mb-5" role="alert" style="background-color: #424a52;border-color: #424a52">
							...
							<div class="alert-text" style="color: #fff;">
								Değerlendirme oranınız sektör ortalamasının içerisinde olup İş kazası oranının 0 olması hedeflenmelidir.
							</div>
						</div><?php
					}elseif ($firma_yuzdesi<$min) {
						$degerlendirme_mesaji="Değerlendirme oranınız sektör ortalama değerinin altında olup İş kazası oranının 0 olması hedeflenmelidir."; ?>
						<div class="alert alert-custom alert-outline-primary fade show mb-5" role="alert" style="background-color: #2a6ab2;border-color: #2a6ab2">
							...
							<div class="alert-text" style="color: #fff;">
								Değerlendirme oranınız sektör ortalama değerinin altında olup İş kazası oranının 0 olması hedeflenmelidir.
							</div>
						</div><?php
...
<script type="text/javascript">
	...
	var sektor_yuzdesi=<?php  echo $sektor_yuzdesi; ?>;
		...
		chart.data = [{
		  "baslik": "Sektör Bazlı Firmanızın İş Kazası Oranı",
		  "yuzde": firma_yuzdesi,
		  "color": am4core.color("#168FC6"),
		}, {
		  "baslik": "Sektörün Firmanıza Göre İş Kazası Oranı",
