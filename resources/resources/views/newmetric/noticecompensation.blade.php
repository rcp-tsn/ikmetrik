...
<div class="container" style="padding: 30px;">
	<div class="row">
			...
			<div class="metric-define-div">
				<p style="text-align: justify;">
					...
					<span class="formul"><b>Hesaplama Formülü :</b> <br>
						...
						Bir Günlük İhbar = Brüt Ücret/30<br>
						İhbar Esas Kazanç = Bir Günlük İhbar*İhbar Günü<br>
						Gelir Vergisi = İhbar Esas Kazanç*0,15<br>
						Damga Vergisi = İhbar Esas Kazanç*0,00759<br>
						Net İhbar Tazminatı = İhbar Esas Kazanç-Gelir Vergisi-Damga Vergisi<br>
						Not: İhbar Günü toplam çalışma ayı 0-6 ay arası ise 14 gün, 6-18 ay arası ise 28 gün, 19-36 ay arası ise 42 gün, 36 ay ve üstü ise 56 gün olarak tanımlanmıştır.<br>
						Not2: Brüt ücrete sosyal hak edişler eklenmemiştir.<br>
						Not3: Muhtemel hesaplama %15 gelir vergisi dilimine göre hesaplanmıştır.</span> <br>
					</span><br><br>
				</p>
			</div>
		</div>
    	...
    	?>
    	<form method="GET" action="/sub-metrics/notice-compensation" class="date-form">
			...
			<a href="/severancepayperperson" class="btn btn-primary font-weight-bolder" style="float: right;">Kişi Bazında İhbar Tazminatı Hesapla</a>
		</form>
		<div class="col-lg-12">
			<!--begin::Card-->
			<div class="card card-custom gutter-b">
				<div class="card-header">
					<div class="card-title" style="width: 100%;">
						<h3 class="card-label"style="width: 50%;">
							Firmanızın İhbar Tazminatı : {{number_format($net_ihbar_tazminati,2,',','.')}}₺
						</h3>
						<h3 class="card-label" style="width: 50%;text-align: right;">
							Sektör Kişi Bazında İhbar Tazminatı :  {{number_format($sektor_yuzdesi,2,',','.')}}₺
						</h3>
					</div>
				</div>
					...
					<div class="alert alert-custom alert-outline-primary fade show mb-5" role="alert" style="background-color: #ff7f00;border-color: #ff7f00;margin-top: 20px;">
						...
						<div class="alert-text" style="color: #fff;">
							...
							@elseif($firma_yuzdesi==0)
								@if($kisiler->count()>0)
									Seçilen tarih aralığındaki çalışanlarınızdan 2 ayı aşkın çalışan olmadığından ihbar yükünüz yoktur.
								@else
				...
				<div class="card-body" style="<?php if($firma_yuzdesi==0 || $sektor_yuzdesi==0) echo 'display: none;' ?>">
					...
					if ($firma_yuzdesi<$min) {
						$degerlendirme_mesaji="İhbar yükünüz değerlendirilmelidir."; ?>
...
<script type="text/javascript">
	...
	var degerlendirme_mesaji= '<?php echo $degerlendirme_mesaji; ?>';
		...
		chart.data = [{
		  "baslik": "Firmanızın Sektöre Göre Kişi Bazlı İhbar Tazminatı",
		  "yuzde": firma_yuzdesi,
		}, {
		  "baslik": "Sektörün Firmanıza Göre Kişi Bazlı İhbar Tazminatı",
