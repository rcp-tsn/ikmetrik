	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div style="width: 33%;min-height: 200px;float: left;padding: 5px 10px;">
				<img src="/pictures/13.png" style="width: 100%;height: auto;">
			</div>
			<div style="width: 60%;float: left;font-size: 15px;padding-top: 10px;">
				<p style="text-align: justify;">
					İşletme bünyesinde tanımlanan ek ödemeler iş tatmini ile direk ilgisi olup çalışanların işletmeye katılımlarını etkilemektedir.Bu sebeb ile artan yan haklar/ek ödemeler dengesi kurumun rekabet edebilirliğini olumlu/olumsuz yönden etki edecektir.İŞletmlerin ek ödeme maliyet metriği insan kaynakları departmanı için büyük önem arzedecektir.Aylık prim hizmet bildirgesinde SGK 'ya bildirilen ek ödemlerin oranını tanımlar.<br><br>
					<span class="formulgoster" id="formulgoster">Formülü Göster</span><br>
					<b class="formul">Hesaplama Formülü : Toplam ek ödeme rakamı/Toplam personel maliyeti</b>
					<br>
				</p>
			</div>
		</div>
    	...
    	?>
		<form method="GET" action="/extrapaycostrate" style="width: 100%;">
			<div class="row">
