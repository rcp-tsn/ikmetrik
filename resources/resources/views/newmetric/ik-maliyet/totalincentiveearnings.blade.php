	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div style="width: 33%;min-height: 200px;float: left;padding: 5px 10px;">
				<img src="/pictures/16.png" style="width: 100%;height: auto;">
			</div>
			<div style="width: 60%;float: left;font-size: 15px;padding-top: 10px;">
				<p style="text-align: justify;">
					...
					<b class="formul">Hesaplama Formülü : Ay bazında toplam teşvik kazanç pasta grafiği</b><br>
				</p>
			</div>
		</div>
		<?php 
    	...
    	?>
    	<form method="GET" action="/totalincentiveearnings" style="width: 100%;">
