...
<div class="container" style="padding: 30px;">
	<div class="row">
		<div class="col-lg-12">
			<h2>Turnover Oranı Nedir?</h2>
			<div class="metric-image-div">
				<img src="/pictures/4.jpg" style="width: 100%;height: auto;">
			</div>
			<div class="metric-define-div">
				<p style="text-align: justify;">
					Çalışanların işletmeye katılmaları veya işletmeden ayrılmaları halinde oluşan çalışma gücü hareketine iş gücü devri denmektedir. Turnover oranı, şirketinizde belirli vadede giriş-çıkış sirkülasyonunu tanımlamış olup, belirlenen dönemde çeşitli nedenlerle oluşan değişken iş gücünü ifade etmektedir.<br><br>
					<span class="formulgoster" id="formulgoster">Formülü Göster <i class="fas fa-caret-down"></i></span><br>
					<span class="formul"><b>Hesaplama Formülü :</b> İşten çıkanlar/Ortalama çalışan sayısı(ayın başı+ayın sonu/2)</span><br>
				</p>
			</div>
		</div>
		<?php
    	...
    	?>
		<form method="GET" action="/sub-metrics/turnover-rate" class="date-form">
			<div class="row">
		...
		<div class="col-lg-12">
			...
			<div class="card card-custom gutter-b">
				<div class="card-header">
					<div class="card-title" style="width: 100%;">
						<h3 class="card-label"style="width: 50%;">
							Firmanızın Turnover Oranı : %{{number_format($firma_yuzdesi,1)}}
						</h3>
						<h3 class="card-label" style="width: 50%;text-align: right;">
							Sektör Turnover Oranı :  %{{number_format($sektor_yuzdesi,1)}}
						</h3>
					</div>
				</div>
					...
					<div class="alert alert-custom alert-outline-primary fade show mb-5" role="alert" style="background-color: #ff7f00;border-color: #ff7f00;margin-top: 20px;">
						...
						<div class="alert-text" style="color: #fff;">
							...
							@elseif($firma_yuzdesi==0)
								@if($firma_isten_ayrilan_sayisi==0)
								Seçilen tarih aralığında firmanızdan ayrılan personel bulunmamaktadır. Dolayısıyla karşılaştırma yapılamamaktadır.
								@else
				...
				<div class="card-body" style="<?php if($firma_yuzdesi==0 || $sektor_yuzdesi==0) echo 'display: none;' ?>">
					...
					<span><b>Firmanızın İşten Ayrılan Personel Sayısı : {{number_format($firma_isten_ayrilan_sayisi,0,',','.')}} Kişi</b></span><br>
					...
					if ($firma_yuzdesi<=$max AND $firma_yuzdesi>=$min) {
						$degerlendirme_mesaji="Değerlendirme oranınız sektör ortalamasının içerisinde olup turnover sektör ortalamasına göre nominal değerdedir."; ?>
						<div class="alert alert-custom alert-outline-primary fade show mb-5" role="alert" style="background-color: #424a52;border-color: #424a52">
							...
							<div class="alert-text" style="color: #fff;">
								Değerlendirme oranınız sektör ortalamasının içerisinde olup turnover sektör ortalamasına göre nominal değerdedir.
							</div>
						</div><?php
					}elseif ($firma_yuzdesi<$min) {
						$degerlendirme_mesaji="Değerlendirme oranınız sektör ortalama değerinin altında olup turnover oranı durumunuz olumlu yönde seyretmektedir."; ?>
						<div class="alert alert-custom alert-outline-primary fade show mb-5" role="alert" style="background-color: #2a6ab2;border-color: #2a6ab2">
							...
							<div class="alert-text" style="color: #fff;">
								Değerlendirme oranınız sektör ortalama değerinin altında olup turnover oranı durumunuz olumlu yönde seyretmektedir.
							</div>
						</div><?php
...
<script type="text/javascript">
	...
	var sektor_yuzdesi=<?php  echo $sektor_yuzdesi; ?>;
		...
		chart.data = [{
		  "baslik": "Sektör Bazlı Firmanızın Turnover Oranı",
		  "yuzde": firma_yuzdesi
		}, {
		  "baslik": "Sektörün Firmanıza Göre Turnover Oranı",
