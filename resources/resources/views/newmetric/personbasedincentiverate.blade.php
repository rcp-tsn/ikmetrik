...
<div class="container" style="padding: 30px;">
	<div class="row">
    	...
    	?>
		<form method="GET" action="/sub-metrics/person-based-incentive-rate" class="date-form">
			<div class="row">
		...
		<div class="col-lg-12">
			...
			<div class="card card-custom gutter-b">
				<div class="card-header">
					<div class="card-title" style="width: 100%;">
						<h3 class="card-label"style="width: 50%;">
							Firmanızın Kişi Bazında Teşvik Tutarı : {{number_format($firma_yuzdesi,2,',','.')}} ₺
						</h3>
						<h3 class="card-label" style="width: 50%;text-align: right;">
							Sektör Kişi Bazında Teşvik Tutarı :  {{number_format($sektor_yuzdesi,2,',','.')}} ₺
						</h3>
					</div>
				</div>
				...
				<div class="card-body" style="<?php if($firma_yuzdesi==0 || $sektor_yuzdesi==0) echo 'display: none;' ?>">
					...
					<span><b>Firmanızın Toplam Teşvik Tutarı : {{number_format($firma_toplam_tesvik_kazanci,2,',','.')}} ₺</b></span><br>
					<span><b>Firmanızın Ortalama Çalışan Sayısı : {{number_format($firma_kisi_sayisi,0,',','.')}} Kişi</b></span>
					<!--begin::Chart-->
					...
					if ($firma_yuzdesi<=$max AND $firma_yuzdesi>=$min) {
						...
						<div class="alert alert-custom alert-outline-primary fade show mb-5" role="alert" style="background-color: #e74332;border-color: #e74332">
							...
							<div class="alert-text" style="color: #fff;">
								İşe alım kriterlerinde potansiyel teşvik şartlarını lütfen gözden geçiriniz. İşe alımdan önce potansiyel teşvik sorgulamalarını yapınız. Potansiyel teşvik sorgulaması için lütfen <a href="/declarations/incentives/potential-incentives" class="alert-text atikla" style="text-decoration: underline;color: #fff;">tıklayınız.</a>
							</div>
						</div><?php
...
<script type="text/javascript">
	...
	var sektor_yuzdesi=<?php  echo $sektor_yuzdesi; ?>;
		...
		chart.data = [{
		  "baslik": "Sektör Bazlı Firmanızın Kişi Bazlı Teşvik Oranı",
		  "yuzde": firma_yuzdesi,
		  "color": am4core.color("#168FC6"),
		}, {
		  "baslik": "Sektörün Firmanıza Göre Kişi Bazlı Teşvik Oranı",
