	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="metric-image-div">
				<img src="/pictures/9.jpg" style="width: 100%;height: auto;">
			</div>
			<div class="metric-define-div">
				<p style="text-align: justify;">
					...
					<span class="formul"><b>Hesaplama Formülü :</b> İyi Niyet Ahlak Dışı Personel Sayısı/Ortalama Personel Sayısı(Ayın Başı+Ayın Sonu/2)</span><br><br>
				</p>
			</div>
		</div>
		<?php
    	...
    	?>
		<form method="GET" action="/sub-metrics/indiscipline-rate" class="date-form">
			<div class="row">
			...
			<div class="card card-custom gutter-b">
					...
					<div class="alert alert-custom alert-outline-primary fade show mb-5" role="alert" style="background-color: #ff7f00;border-color: #ff7f00;margin-top: 20px;">
						...
						<div class="alert-text" style="color: #fff;">
							...
							@elseif($firma_yuzdesi==0)
								@if($firma_ahlaksiz_sayisi==0 AND $firma_calisan_sayisi!=0)
								Seçilen tarih aralığında firmanızdan disiplinsizlikten ötürü ayrılan personel yoktur. Dolayısıyla karşılaştırma yapılamamaktadır.
								@else
				...
				<div class="card-body" style="<?php if($firma_yuzdesi==0 || $sektor_yuzdesi==0) echo 'display: none;' ?>">
					...
					if ($firma_yuzdesi<=$max AND $firma_yuzdesi>=$min) {
						$degerlendirme_mesaji="Değerlendirme oranınız sektör ortalamasının içerisinde olup disiplinsizlik oranınız sektör ortalamasına göre nominal değerdedir."; ?>
						...
						$degerlendirme_mesaji="Değerlendirme oranınız sektör ortalama değerinin altında olup ,disiplinsizlik oranınız olumlu yönde seyretmektedir."; ?>
