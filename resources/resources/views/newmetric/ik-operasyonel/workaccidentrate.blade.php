	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div style="width: 33%;min-height: 200px;float: left;padding: 5px 10px;">
				<img src="/pictures/3.png" style="width: 100%;height: auto;">
			</div>
			<div style="width: 60%;float: left;font-size: 15px;">
				<p style="text-align: justify;">
					...
					<b class="formul">Hesaplama Formülü : Kaza sayısı/Ortalama çalışan sayısı(ayın başı+ayın sonu/2)</b><br>
				</p>
			</div>
		</div>
		<?php 
    	...
    	?>
    	<form method="GET" action="/workaccidentrate" style="width: 100%;">
