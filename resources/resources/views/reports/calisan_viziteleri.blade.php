                    ...
                    <div class="card card-custom gutter-b ">
                        <div class="card-header h-auto border-0">
                            <div class="card-title py-5">
                                <h3 class="card-label">
                                    <span class="d-block text-dark font-weight-bolder">Çalışan Viziteleri</span>
                                </h3>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-lg-12">
                                    <div class="card card-body border-top-1 border-top-pink">
                                        <div class="text-center">
                                            ...
                                            <button type="button" onclick="stepManager.work('calisan-viziteleri');" class="btn btn-success start-incentive"><b><i class="icon-collaboration"></i></b> Devam Et</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <table class="table table-bordered" id="kt_datatable">
                                    ...
                                    @foreach($work_vizites as $work_vizite)
                                        <tr>
                                            <td>{{ $work_vizite->takip_no }}</td>
                                            <td>{{ $work_vizite->rapor_sira_no }}</td>
                                            <td>{{ $work_vizite->tck }}</td>
                                            <td>{{ $work_vizite->ad_soyad }}</td>
                                            <td>{{ $work_vizite->vaka }}</td>
                                            <td>{{ $work_vizite->poliklinik_tarihi->format('d/m/Y') }}</td>
                                            <td>{{ $work_vizite->isbasi_tarihi->format('d/m/Y') }}</td>
...
@push('scripts')
    <script>
        ...
        var stepManager = {
            currentStep: 'calisan-viziteleri',
            work: function (step) {
