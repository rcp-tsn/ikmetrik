...
<div id="kt_quick_settings" class="offcanvas offcanvas-left p-10">

    <!--begin::Header-->
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-10">
        <h3 class="font-weight-bold m-0">
            Tanımlamalar
            <small class="text-muted font-size-sm ml-2">İK Metrik Tanımlamalar</small>
        </h3>
        <a href="#" class="btn btn-xs btn-icon btn-light btn-hover-danger" id="kt_quick_settings_close">
            ...
            <div class="col-6">
                <a href="{{ route('users.index') }}"
                   class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
					<span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                    ...
                    <span class="d-block font-weight-bold font-size-h6 mt-2">Sistem<br/>Kullanıcılar</span>
                </a>
            </div>
            @hasanyrole('Admin')
            <div class="col-6">
                <a href="{{ route('users.demo') }}"
                   class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
					<span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <span class="d-block font-weight-bold font-size-h6 mt-2">Demo<br/>Kullanıcıları</span>
                </a>
            </div>
            @endhasanyrole
        </div>
        ...
        <div class="row gutter-b">
            <div class="col-6">
                <a href="{{ route('permissions.index') }}"
                   class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-danger m-0"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-08-20-140804/theme/html/demo10/dist/../src/media/svg/icons/Home/Key.svg--><svg
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            transform="translate(15.985281, 8.985281) rotate(-315.000000) translate(-15.985281, -8.985281) "/>
                    ...
                    <span class="d-block font-weight-bold font-size-h6 mt-2">Yetkiler</span>
                </a>
            </div>
            <div class="col-6">
                <a href="{{ route('roles.index') }}"
                   class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-danger m-0"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-08-20-140804/theme/html/demo10/dist/../src/media/svg/icons/Communication/Shield-user.svg--><svg
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                            height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <path
            ...
            fill="#000000" opacity="0.3"/>
                    ...
                    <span class="d-block font-weight-bold font-size-h6 mt-2">Roller</span>
                </a>
            </div>
        </div>
        <div class="row gutter-b">
            <div class="col-6">
                <a href="{{ route('companies.index') }}"
                   class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-danger m-0"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-08-20-140804/theme/html/demo10/dist/../src/media/svg/icons/Home/Building.svg--><svg
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                            height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <path
            ...
            fill="#000000" opacity="0.3"/>
                    ...
                    <span class="d-block font-weight-bold font-size-h6 mt-2">Firma İşlemleri</span>
                </a>
            </div>
            <div class="col-6">
                <a href="{{ route('packets.index') }}"
                   class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    ...
                    <span class="d-block font-weight-bold font-size-h6 mt-2">Paket İşlemleri</span>
                </a>
            </div>
        </div>
        <div class="row gutter-b">
            <div class="col-6">
                <a href="{{ route('sectors.index') }}"
                   class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    ...
                    <span class="d-block font-weight-bold font-size-h6 mt-2">Sektörler</span>
                </a>
            </div>
            <div class="col-6">
                <a href="{{ route('egns.index') }}"
                   class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <span class="d-block font-weight-bold font-size-h6 mt-2">Eksik Gün Nedenleri</span>
                </a>
            </div>
        </div>
        <div class="row gutter-b">
            <div class="col-6">
                <a href="{{ route('work_titles.index') }}"
                   class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <span class="d-block font-weight-bold font-size-h6 mt-2">Ünvanlar</span>
                </a>
            </div>
            <div class="col-6">
                <a href="{{ route('jobs.index') }}"
                   class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    ...
                    <span class="d-block font-weight-bold font-size-h6 mt-2">Meslekler</span>
                </a>
            </div>
        </div>
            ...
            <div class="col-6">
                <a href="{{ route('departments.index') }}"
                   class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    ...
                    <span class="d-block font-weight-bold font-size-h6 mt-2">Departmanlar</span>
                </a>
            </div>
            <div class="col-6">
                <a href="{{ route('crm_supports.index') }}"
                   class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000"/>
                    ...
                    <span class="d-block font-weight-bold font-size-h6 mt-2">Destek Talepleri</span>
                </a>
            </div>
        </div>
        ...
        <div class="row gutter-b">
            <div class="col-6">
                <a href="{{ route('sgk_companies.index') }}"
                   class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <span class="d-block font-weight-bold font-size-h6 mt-2">SGK<br/>Firmaları</span>
                </a>
            </div>
            <div class="col-6">
                <a href="{{ route('company_assignments.index') }}"
                   class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <span class="d-block font-weight-bold font-size-h6 mt-2">Firma Atamaları</span>
                </a>
            </div>
        </div>
        @endhasanyrole
...
<div id="kt_quick_metric_settings" class="offcanvas offcanvas-left p-10">

    <!--begin::Header-->
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-10">
        <h3 class="font-weight-bold m-0">
            Metrik Tanımlamalar
            <small class="text-muted font-size-sm ml-2">İK Metrik Tarama Tanımlamaları</small>
        </h3>
        <a href="#" class="btn btn-xs btn-icon btn-light btn-hover-danger" id="kt_quick_metric_settings_close">
            <i class="ki ki-close icon-xs text-muted"></i>
        </a>
    </div>
...
@if(Auth::user()->hasRole('Admin') || Auth::user()->hasRole('Metrik') || Auth::user()->modulePermit(2))
    <!--begin::Content-->
        <div class="offcanvas-content pr-5 mr-n5">
            @hasanyrole('Admin|Owner|Metrik')
            <div class="row gutter-b">
                <div class="col-6">
                    <a href="{{ route('declarations.incentives.metrik') }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <span class="d-block font-weight-bold font-size-h6 mt-2">Tahakkuk Listeleri</span>
                    </a>
                </div>
                <div class="col-6">
                    <a href="{{ route('declarations.incentives.is-kazasi') }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <span class="d-block font-weight-bold font-size-h6 mt-2">İş<br/>Kazaları</span>
                    </a>
                </div>
            </div>
            <div class="row gutter-b">
                <div class="col-6">
                    <a href="{{ route('declarations.incentives.calisan-viziteleri') }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <span class="d-block font-weight-bold font-size-h6 mt-2">Çalışan Viziteleri</span>
                    </a>
                </div>
                <div class="col-6">
                    <a href="{{ route('declarations.incentives.giris-cikis-bildirgesi-start') }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <span class="d-block font-weight-bold font-size-h6 mt-2">Giriş Çıkış Bildirgesi</span>
                    </a>
                </div>
            </div>
            <div class="row gutter-b">
                <div class="col-6">
                    <a href="{{ route('declarations.incentives.kimlik-bildirim-sistemi') }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <span class="d-block font-weight-bold font-size-h6 mt-2">Kimlik Bildirim Sistemi</span>
                    </a>
                </div>
                <div class="col-6">
                    <a href="{{ route('declarations.incentives.potential') }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <span class="d-block font-weight-bold font-size-h6 mt-2">Potansiyel  Teşvik Sorgulama</span>
                    </a>
                </div>
                <div class="col-12">
                    <a href="{{ route('undue.index') }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <span class="d-block font-weight-bold font-size-h6 mt-2">Yersiz Yararlanma</span>
                    </a>
                </div>
            </div>
            @endhasanyrole
...
<div id="kt_quick_incentives" class="offcanvas offcanvas-left p-10">

    <!--begin::Header-->
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-10">
        <h3 class="font-weight-bold m-0">
            Teşvik İşlemleri
            <small class="text-muted font-size-sm ml-2">İK Metrik Teşvik</small>
        </h3>
        <a href="#" class="btn btn-xs btn-icon btn-light btn-hover-danger" id="kt_quick_incentives_close">
            <i class="ki ki-close icon-xs text-muted"></i>
        </a>
    </div>
    ...
    <!--begin::Content-->
    <div class="offcanvas-content pr-5 mr-n5">
        @if(Auth::user()->hasRole('Admin') || Auth::user()->hasRole('Teşvik'))
            @hasanyrole('Admin|Teşvik')
            <div class="row gutter-b">
                <div class="col-12">
                    <a href="{{ route('declarations.incentives.options.form') }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
					<span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                        ...
                        <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">Teşvik Tarama</span>
                    </a>
                </div>
            </div>
            ...
            <div class="row gutter-b">
                <div class="col-6">
                    <a href="{{ route('declarations.incentives.current_incentives') }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                    ...
                    <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">Cari<br/>Teşvikler</span>
                    </a>
                </div>
                <div class="col-6">
                    <a href="{{ route('control-gain-incentives', Carbon\Carbon::now()->startOfMonth()->subMonth()->format('Y-m-d')) }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                    ...
                    <!--end::Svg Icon--></span> <span
                            class="d-block font-weight-bold font-size-h6 mt-2">Hakediş Raporu</span>
                    </a>
                </div>
            </div>
            <div class="row gutter-b">
                <div class="col-6">
                    <a href="{{ route('declarations.incentives.gain_incentives') }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
            <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                ...
                <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">Hakedişler</span>
                    </a>
                </div>
                <div class="col-6">
                    <a href="{{ route('declarations.incentives.past', '6111') }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
            <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
                ...
                <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">Geçmiş Dönem</span>
                    </a>
                </div>
            </div>
            @endhasanyrole
        ...
        @if(Auth::user()->hasRole('Admin') || Auth::user()->hasRole('Teşvik') || Auth::user()->modulePermit(1))
            <div class="row gutter-b">
                <div class="col-6">
                    <a href="{{ route('declarations.incentives.pdf-incentive-reports') }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
    <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
        ...
        <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">Teşvik Raporları</span>
                    </a>
                </div>
                <div class="col-6">
                    <a href="{{ route('declarations.incentives.potential') }}"
    ...
    <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
        ...
        <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">Potansiyel  Teşvik Sorgulama</span>
                    </a>
                </div>
                <div class="col-6">
                    <a href="{{ route('undue.index') }}"
    ...
    <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
        ...
        <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">Yersiz Yararlanma</span>
                    </a>
                </div>
            </div>
        @endif
...
<div id="kt_quick_metrics" class="offcanvas offcanvas-left p-10">

    <!--begin::Header-->
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-10">
        <h3 class="font-weight-bold m-0">
            Metrik İşlemleri
            <small class="text-muted font-size-sm ml-2">İK Metrikleri</small>
        </h3>
        <a href="#" class="btn btn-xs btn-icon btn-light btn-hover-danger" id="kt_quick_metrics_close">
            <i class="ki ki-close icon-xs text-muted"></i>
        </a>
    </div>
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        @if(Auth::user()->hasRole('Admin') || Auth::user()->hasRole('Metrik') || Auth::user()->modulePermit(2))
            ...
            <div class="row gutter-b">
                <div class="col-12">
                    <a href="{{ route('metrics', createHashId(2)) }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M3.0603968,10.0120794 C3.54712466,6.05992157 6.91622084,3 11,3 L11,11.6 L3.0603968,10.0120794 Z"
              fill="#000000"/>
                    ...
                    <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">İK Operasyonel KPI</span>
                    </a>
                </div>
            </div>
            <div class="row gutter-b">
                <div class="col-12">
                    <a href="{{ route('metrics', createHashId(1)) }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
					<span class="svg-icon svg-icon-3x svg-icon-danger m-0">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M3.0603968,10.0120794 C3.54712466,6.05992157 6.91622084,3 11,3 L11,11.6 L3.0603968,10.0120794 Z"
              fill="#000000"/>
                        ...
                        <!--end::Svg Icon--></span> <span class="d-block font-weight-bold font-size-h6 mt-2">İK Maliyet KPI</span>
                    </a>
                </div>
            </div>
            <div class="row gutter-b">
                <div class="col-12">
                    <a href="{{ route('metrics', createHashId(3)) }}"
                       class="btn btn-block btn-light btn-hover-danger text-dark-50 text-center py-10 px-5">
                <span class="svg-icon svg-icon-3x svg-icon-danger m-0">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M3.0603968,10.0120794 C3.54712466,6.05992157 6.91622084,3 11,3 L11,11.6 L3.0603968,10.0120794 Z"
              fill="#000000"/>
                    ...
                    <!--end::Svg Icon--></span> <span
                            class="d-block font-weight-bold font-size-h6 mt-2">İK İşletme KPI</span>
                    </a>
                </div>
            </div>
        @endif
